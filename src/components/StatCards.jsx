        ...
        return (
          ...
          >
            <div className={`flex min-w-0 items-center ${horizontal ? 'gap-1 sm:gap-2.5' : 'gap-2.5'}`}>
              ...
              <div className={horizontal ? 'flex min-w-0 -translate-y-0.5 items-center gap-0.5 whitespace-nowrap text-[10px] font-normal leading-none sm:text-sm' : 'min-w-0'}>
                <div className={`${horizontal ? 'whitespace-nowrap' : 'truncate text-xs'} text-gray-500`}>{card.label}{horizontal && '：'}</div>
                <div className={`${horizontal ? 'inline-flex items-center font-normal' : 'mt-1 text-xl font-medium sm:text-2xl'} whitespace-nowrap leading-none text-gray-900`}>
