    ...
    >
      ...
      >
        ...
        <button
          ...
          onClick={onClose}
          aria-label="关闭详细信息"
          className="absolute top-2 right-2 z-30 w-7 h-7 flex items-center justify-center bg-white/20 hover:bg-white/30 rounded-full text-white transition-colors"
        >
          <X size={16} />
        </button>

        <div ref={scrollContainerRef} className="flex-1 min-h-0 overflow-y-auto overscroll-contain">
          <div className="gradient-header h-11 flex-shrink-0 rounded-t-xl" />
