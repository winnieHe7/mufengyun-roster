...
import { ArrowLeft, Settings, Users, ToggleLeft, ToggleRight, Download, UserPlus, Trash2, KeyRound } from 'lucide-react'
              ...
              <div className="bg-white rounded-xl shadow-sm border border-warm-200 p-6 mb-4">
                ...
                <form onSubmit={handleCreate} className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <input type="text" value={newAccount.major} onChange={e => setNewAccount({...newAccount, major: e.target.value})} className={inputClass} placeholder="如 计算机科学与技术" />
                  </div>
                  <div>
                    <label className="block text-sm text-gray-500 mb-1">所在城市</label>
                    <input type="text" value={newAccount.city} onChange={e => setNewAccount({...newAccount, city: e.target.value})} className={inputClass} placeholder="如 北京" />
                  </div>
                  <div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm border border-warm-200">
              ...
              <div className="grid grid-cols-2 gap-4 text-sm">
                <div>
                  ...
                  <p className="text-gray-700 font-medium">v1.1.0</p>
                </div>
                <div>
